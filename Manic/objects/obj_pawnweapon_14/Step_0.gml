...
if (instance_exists(owner)){
    ...
    if (attack) && (attack_time <= 0){
	    ...
	    var xpos = owner.x + lengthdir_x(38 * owner.scale, dir);
	    var ypos = owner.y + lengthdir_y(38 * owner.scale, dir);
		var isEnemy = true;
	    ...
	    scr_weapon_melee_detect(isEnemy, owner.x, owner.y, dir, scr_pawn_weapon_damage(8), 3.5, 38, obj_proj_2, owner.x, owner.y);
