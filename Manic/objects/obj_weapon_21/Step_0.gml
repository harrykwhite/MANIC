...
var xpos = x + lengthdir_x(42, mdir);
var ypos = y + lengthdir_y(42, mdir);
...
if (scr_input_is_pressed(InputBinding.Attack)) && (global.player_stamina_active) && (!global.game_pause){
    if (attack_can){
		...
		scr_weapon_melee_detect(false, x, y, s.image_angle, attack_damage + choose(0, 1), attack_strength, 42, obj_proj_2, obj_player.x, obj_player.y);
