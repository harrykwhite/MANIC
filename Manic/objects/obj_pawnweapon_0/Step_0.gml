...
if (instance_exists(owner)){
    ...
    if (attack) && (attack_time <= 0){
	    ...
	    var xpos = x + lengthdir_x(29 * owner.scale, dir);
	    var ypos = y + lengthdir_y(29 * owner.scale, dir);
		var isEnemy = true;
		...
		scr_weapon_melee_detect(isEnemy, x, y, dir, scr_pawn_weapon_damage(0), 1.5, 38, obj_proj_1, owner.x, owner.y);
