...
if (scr_input_is_pressed(InputBinding.Attack)) && (global.player_stamina_active) && (!global.game_pause){
    var xpos = global.player_position_x + lengthdir_x(59, mdir);
    var ypos = global.player_position_y + lengthdir_y(59, mdir);
    ...
    if (attack_can){
		...
		scr_weapon_melee_detect(false, global.player_position_x, global.player_position_y, s.image_angle, attack_damage, attack_strength, 53, obj_proj_3, obj_player.x, obj_player.y);
