if (instance_exists(turret)){
	if (shoot){
		...
		part_type_direction(global.pt_smoke_5, ang - 6, ang + 6, 0, 0);
        part_particles_create(global.ps_front, xpos + lengthdir_x(3, ang) + random_range(-3, 3), ypos + lengthdir_y(3, ang) + random_range(-3, 3), global.pt_smoke_5, 2);
