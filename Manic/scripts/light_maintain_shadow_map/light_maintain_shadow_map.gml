...
if (shadowMap == noone || !surface_exists(shadowMap) || surface_get_width(shadowMap) != size || surface_get_height(shadowMap) != size){
	if (size == 0){
		return false;
	}
	
	if (shadowMap != noone && surface_exists(shadowMap)){
