with(obj_controller_ui){
	if (global.game_input_type == InputType.Keyboard){
		var throwlist = scr_input_get_name(InputBinding.Throw, true, true);
		...
		tutourial_text[TutourialStage.Throw] = "Throw your weapon by pressing " + throwlist[0] + " or " + throwlist[1];
