...
if ((mouse_check_button_pressed(mb_left)) || (shoot_continue_time > 0)) && (global.game_pause == false){
    if ((shoot_can == true) && (global.weapon_slotammo[global.weapon_slotcurrent] > 0)) || (shoot_continue_time > 0){
        ...
        shoot_can = false;
        shoot_time = 65; // The amount of frames in between the next shot.
